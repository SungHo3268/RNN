...
source_input, source_len = make_source(f_train_en, en_to_id, max_sen_len=51, reverse=False)
target_input, target_output = make_target(f_train_de, de_to_id, max_sen_len=51)
